...
int mpack_pack_raw(mpack_packer *p, void *data, size_t len)
{
...
static int mpack_pack_cint(mpack_packer *p, uintmax_t i, uint8_t enc_base)
{
...
int mpack_pack_array_start(mpack_packer *p, size_t count)
{
	uint8_t buf[5];
	size_t len;
	if (count <= 15) {
